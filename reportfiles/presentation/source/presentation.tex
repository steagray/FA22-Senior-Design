...
\frameT{Tutorial}{
	\begin{itemize}
		\item Initial tutorial design
	\end{itemize}
	\includegraphics[scale=0.25]{figures/tut_mockup.png}
}

\frameT{Overworld and Dungeon} {
	\begin{minipage}{1\linewidth}
		\begin{itemize}
		\item Overworld design phase
		\end{itemize}
	\includegraphics{figures/OverworldLayout.png}
	\end{minipage}
}
...
\frameT{Overworld and Dungeon} {
	\begin{minipage}{0.50\linewidth}
		\begin{itemize}
		\item Dungeon design phase
		\end{itemize}
	\includegraphics[scale=0.25]{figures/DungeonLayout.png}
	\end{minipage}
}

\frameT{Side Area} {
	\begin{itemize}
		\item Initial sample side area
	\end{itemize}
	\includegraphics[scale=0.15]{figures/designexample.png}
}
