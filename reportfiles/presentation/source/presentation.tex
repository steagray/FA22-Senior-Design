...
\frameT{Inspirations} {
    ...
    \begin{minipage}[b]{0.4\linewidth}
      \centering
				%  ------- post pictures here --------
			\includegraphics[width=.4\linewidth]{figures/illumine.png}
			\includegraphics[width=.4\linewidth]{figures/zelda.png}
			\includegraphics[width=.4\linewidth]{figures/thomas.jpg}
			\includegraphics[width=.4\linewidth]{figures/ourgame.png}
    \end{minipage}
  \end{figure}
}
...
\frameT{Comparison} {
    ...
    \begin{minipage}[b]{0.53\linewidth}
      \centering
			\includegraphics[width=.53\linewidth]{figures/earlyproj.png}
    \end{minipage}
    \hspace{0.5cm}
    \begin{minipage}[b]{0.4\linewidth}
      \centering
			\includegraphics[width=.4\linewidth]{figures/currproj/png}
    \end{minipage}
  \end{figure}
}
